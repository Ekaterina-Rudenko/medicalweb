...
public class Visit extends AbstractEntity {
    ...
    public Visit(long visitId, long specializationId, long doctorId, long serviceId,
                 LocalDateTime visitStart, TypePayment typeOfPayment,
                 VisitState visitState, long patientId) {
        this.visitId = visitId;
        this.specializationId = specializationId;
        this.doctorId = doctorId;
        this.serviceId = serviceId;
        this.date = visitStart;
        this.typeOfPayment = typeOfPayment;
    ...
    @Override
    public int hashCode() {
        int result = 31 * (int) (specializationId * doctorId * visitId * patientId / 13);
    ...
    public String toString() {
        ...
        sb.append(", visitStart=").append(date);
