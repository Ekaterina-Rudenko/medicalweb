...
public class ConnectionPool {
    ...
    private ConnectionPool() {
        ...
        //registerDrivers регистрируются 1 раз. Сделать файл пропертис.
        //естьсмысл этот код перенести в другой класс
        //метод получения конненкшена, внутрь цикла, который создает коннекшн и глуштьб его логами
